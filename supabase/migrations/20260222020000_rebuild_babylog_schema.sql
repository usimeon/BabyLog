-- Hard rebuild of BabyLog public schema.
-- Use this when tables were manually altered and no longer match app expectations.

create extension if not exists pgcrypto;

drop table if exists public.daily_ai_insights cascade;
...
drop table if exists public.diaper_logs cascade;
...
create index idx_feed_user_id on public.feed_events(user_id);
create index idx_feed_baby_time on public.feed_events(baby_id, timestamp desc);
create index idx_measurements_user_id on public.measurements(user_id);
create index idx_measurements_baby_time on public.measurements(baby_id, timestamp desc);
create index idx_temperature_logs_user_id on public.temperature_logs(user_id);
create index idx_temperature_logs_baby_time on public.temperature_logs(baby_id, timestamp desc);
create index idx_diaper_logs_user_id on public.diaper_logs(user_id);
create index idx_diaper_logs_baby_time on public.diaper_logs(baby_id, timestamp desc);
create index idx_medication_logs_user_id on public.medication_logs(user_id);
create index idx_medication_logs_baby_time on public.medication_logs(baby_id, timestamp desc);
create index idx_milestones_user_id on public.milestones(user_id);
create index idx_milestones_baby_time on public.milestones(baby_id, timestamp desc);
create unique index idx_daily_ai_insights_user_baby_date on public.daily_ai_insights(user_id, baby_id, date);
create index idx_daily_ai_insights_user_id on public.daily_ai_insights(user_id);
